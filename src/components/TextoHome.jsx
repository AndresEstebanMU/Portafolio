...
const TextoHome = () => {
    const handleDescargar = () => {
        const url = '/Curriculum-2025.pdf'; // Ruta al archivo en el directorio public
        window.open(url);
      };
    ...
    return (
        ...
        >
            <div className="flex flex-col gap-5 items-center  text-center text-xl md:text-3xl  text-white">
                ...
                <button onClick={ handleDescargar } className="p-5 bg-red-900 rounded-xl hover:bg-red-700 transition-all w-full xl:w-1/2">Descargar CV</button>
            </div>
        </motion.div>
    )
}
