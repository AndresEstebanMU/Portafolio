...
const CardAbout = () => {
  return (
    <div className='flex flex-col w-full justify-center items-center px-3 md:px-28 lg:px-20 gap-5  lg:flex-row  bg-black mb-20'>
      <motion.div
        initial={{ scale: 0 }}
        ...
        <Image
          ...
          width={150}
          height={150}
          className='rounded-3xl md:m-24 mt-2 md:w-40 w-24'
        />
